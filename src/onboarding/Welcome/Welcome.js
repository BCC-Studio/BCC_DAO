  ...
  return (
    ...
    >
      ...
      <p
        ...
        `}
      >
        Do you need more information about BCC Studio?{' '}
        <Link href="https://bccstudio.biz/" external>
          Visit our homepage
        </Link>
      </p>
    </Layout>
...
function CreateSubtitle({ error }) {
  ...
  return 'Start your organization with BCC Studio'
}
